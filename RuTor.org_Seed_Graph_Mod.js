...
GM_addStyle('#qmegas_settings { width: 400px; height: 400px; position: fixed; left: 0; top: 0; background-color: #fff; border: 1px solid #a00; }');
...
GM_addStyle('#qmegas_settings .fields .row .col1 { padding-left: 24px; width: 276px; float: left; }');
GM_addStyle('#qmegas_settings .fields .row .col2 { width: 300px; float: left; }');
...
function RutorScript()
{
	...
	this.markLines = function()
	{
		...
		$('tr.gai, tr.tum').each(function(){
		    ...
		    if (obj.settings.mark_year && ((sp1a.innerHTML.indexOf('(2020)') !== -1) || (sp1a.innerHTML.indexOf('-2020)') !== -1) || (sp1a.innerHTML.indexOf('(2020-') !== -1)))
		    ...
		    if (obj.settings.mark_amedia && ((sp1a.innerHTML.indexOf('| Amedia') !== -1) || (sp1a.innerHTML.indexOf('| Amedia') !== -1) || (sp1a.innerHTML.indexOf('Amedia,') !== -1) || (sp1a.innerHTML.indexOf(', Amedia') !== -1)))
