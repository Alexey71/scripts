...
function RutorScript()
{
	...
	this.markLines = function()
	{
		...
		$('tr.gai, tr.tum').each(function(){
		    ...
		    if (obj.settings.mark_year && ((sp1a.innerHTML.indexOf('(2021)') !== -1) || (sp1a.innerHTML.indexOf('-2021)') !== -1) || (sp1a.innerHTML.indexOf('(2021-') !== -1) || (sp1a.innerHTML.indexOf('(2022)') !== -1) || (sp1a.innerHTML.indexOf('-2022)') !== -1) || (sp1a.innerHTML.indexOf('(2022-') !== -1)))
